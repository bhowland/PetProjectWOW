 ...
 */
@WebServlet(name = "GargraServlet")
public class GargraServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String hql = "select name FROM petInfo.PetsGeneral where creatureId=34587";
        String allHql = "FROM petInfo.PetsGeneral where creatureId=34587";

        String hql2 = "select name FROM petInfo.PetsGeneral where creatureId=68841";
        String allHql2 = "FROM petInfo.PetsGeneral where creatureId=68841";
